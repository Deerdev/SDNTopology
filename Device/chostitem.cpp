...
CHostItem::CHostItem(QGraphicsItem *parent, QGraphicsScene *scene):CBaseObject(parent,scene)
{
    m_scene = scene;
...
void CHostItem::highLightSwitch(CHostItemInfo &_switchInfo)
{

}

void CHostItem::paint(QPainter * painter, const QStyleOptionGraphicsItem * option, QWidget * widget)
{
    QPen t_pen;
...
//    }
    ...
    QString t_str2 = m_hostInfo.name;
...
QRectF CHostItem::boundingRect() const
{
